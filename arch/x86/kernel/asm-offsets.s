...
.ascii "->TASK_threadsp $2944 offsetof(struct task_struct, thread.sp)"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets.c:47: 	OFFSET(TASK_stack_canary, task_struct, stack_canary);
# 47 "arch/x86/kernel/asm-offsets.c" 1
	
.ascii "->TASK_stack_canary $1432 offsetof(struct task_struct, stack_canary)"	#
# 0 "" 2
