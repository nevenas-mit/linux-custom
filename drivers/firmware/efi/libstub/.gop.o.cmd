savedcmd_drivers/firmware/efi/libstub/gop.o := gcc -Wp,-MMD,drivers/firmware/efi/libstub/.gop.o.d -nostdinc -I./arch/x86/include -I./arch/x86/include/generated -I./include -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -Werror -mcmodel=small -m64 -D__KERNEL__ -std=gnu11 -fPIC -fno-strict-aliasing -mno-red-zone -mno-mmx -mno-sse -fshort-wchar -Wno-pointer-sign -Wno-address-of-packed-member -fno-asynchronous-unwind-tables -Os -DDISABLE_BRANCH_PROFILING -include ./include/linux/hidden.h -D__NO_FORTIFY -ffreestanding -fno-stack-protector -D__DISABLE_EXPORTS    -DKBUILD_MODFILE='"drivers/firmware/efi/libstub/gop"' -DKBUILD_BASENAME='"gop"' -DKBUILD_MODNAME='"gop"' -D__KBUILD_MODNAME=kmod_gop -c -o drivers/firmware/efi/libstub/gop.o drivers/firmware/efi/libstub/gop.c  
